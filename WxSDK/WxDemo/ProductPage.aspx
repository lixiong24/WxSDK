...
<body>
	...
	<div align="center">
		<asp:Button ID="Button1" runat="server" Text="立即购买" Style="width: 210px; height: 50px;
			border-radius: 15px; background-color: #00CD00; border: 0px #FE6714 solid; cursor: pointer;
			color: white; font-size: 16px;" OnClick="Button1_Click" />
	</div>
	<br />
	<br />
	<br />
	...
	<div align="center">
		<asp:Button ID="Button2" runat="server" Text="立即购买" Style="width: 210px; height: 50px;
			border-radius: 15px; background-color: #00CD00; border: 0px #FE6714 solid; cursor: pointer;
			color: white; font-size: 16px;" OnClick="Button2_Click" />
	</div>
	</form>
